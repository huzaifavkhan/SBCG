...
import { TrendingUp, Shield, Users, Zap, ArrowRight, Box, Truck, Code, CheckCircle, Rocket, Factory, BarChart3, Handshake, RefreshCcw, MessageSquare } from "lucide-react";
...
const Features = () => {
  ...
  const features = [
    {
      ...
      description: "Comprehensive business analysis and strategic roadmap development to position your company for sustainable growth and market leadership.",
      image: "/uploads/strategic-planning.jpg"
    },
    {
      icon: <Shield className="w-10 h-10 text-white transition-transform duration-300 transform" />,
      title: "Risk Management",
      description: "Proactive risk assessment and mitigation strategies to protect your business from market volatility and operational challenges.",
      image: "/uploads/risk-management.jpg"
    },
    {
      icon: <Users className="w-10 h-10 text-white transition-transform duration-300 transform" />,
      title: "Organizational Development",
      description: "Transform your organizational structure and culture to maximize efficiency, productivity, and employee engagement across all levels.",
      image: "/uploads/organizational-development.jpg"
    },
    {
      icon: <Zap className="w-10 h-10 text-white transition-transform duration-300 transform" />,
      title: "Digital Transformation",
      description: "Navigate the digital landscape with comprehensive technology integration and process optimization for competitive advantage.",
      image: "/uploads/digital-transformation.jpg"
    }
  ];
  ...
  //   description: "Streamlined operations and reduced costs by 30% through strategic process reengineering and digital transformation initiatives."
  // }, {
  //   image: "/lovable-uploads/5463c9c5-0946-4280-a14b-17636ff69a98.png",
  //   title: "Market Expansion Strategy",
  //   description: "Guided Fortune 500 company through successful international expansion, establishing presence in 12 new markets within 18 months."
  // }, {
  //   image: "/lovable-uploads/c5f8ee24-9815-4ebe-b65d-6f3d449feb8b.png",
  //   title: "Digital Transformation",
  //   description: "Led comprehensive digital overhaul for traditional retailer, resulting in 150% increase in online revenue and improved customer experience."
  // }];

  const stepFlowItems = [{
    icon: <BarChart3 className="h-10 w-10 text-gray-700" />,
    title: "Strategic Analysis",
    description: "Deep-dive analysis of your business challenges and market opportunities"
  }, {
    icon: <Factory className="h-10 w-10 text-gray-700" />,
    title: "Proven Methodologies",
    description: "Time-tested frameworks and best practices from 12+ years of experience"
  }, {
    icon: <Handshake className="h-10 w-10 text-gray-700" />,
    title: "Partnership Approach",
    description: "Collaborative implementation with your team for lasting change"
  }];
  ...
  return <>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8" ref={featuresRef}> 
          <div className="text-center mb-10 max-w-3xl mx-auto feature-item">
            ...
            <p className="text-gray-600 mt-4">
              Our comprehensive consulting approach transforms business challenges into competitive advantages through strategic planning, operational excellence, and innovative solutions.
            </p>
          </div>
          ...
          {/* <div className="mt-16 mb-8 feature-item">
            <div className="text-center mb-8">
              ...
              <h3 className="text-2xl font-bold">Real-World Success Stories</h3>
              <p className="text-gray-600 mt-3 max-w-2xl mx-auto">
                Discover how our strategic consulting approach has transformed businesses across industries, 
                from manufacturing optimization to digital transformation.
            ...
            <div className="rounded-xl overflow-hidden bg-white p-4 feature-item">
              <Carousel className="w-full max-w-7xl mx-auto">
                <CarouselContent className="flex">
                  {consultingCaseStudies.map((study, index) => <CarouselItem key={index} className="md:basis-1/3 flex-shrink-0">
              ...
              <div className="text-center mt-6 text-sm text-gray-600">
                <p className="font-medium">These examples showcase just a few ways our strategic consulting drives measurable business results</p>
              </div>
            </div>
          </div> */}
        </div>
      ...
      <section id="methodology" className="bg-gray-50 py-10 md:py-16">
        <div className="w-full px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-block mb-2 px-3 py-1 bg-orange-100 text-[#ff5310] rounded-full text-sm font-medium">
              Our Methodology
            </div>
            <h2 className="text-3xl font-bold mb-4">How our consulting works</h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
              SBCG combines proven methodologies with innovative approaches, 
              allowing us to deliver transformative results with reduced risk and accelerated timelines.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8 mb-10 transition-all duration-300 hover:shadow-xl">
              ...
              {stepFlowItems.map((item, index) => <HoverCard key={index}>
                  ...
                  <HoverCardContent className="w-80 shadow-lg">
                    <div className="space-y-2">
                      ...
                      {index === 0 && <p className="text-xs text-gray-500">Our comprehensive analysis provides the foundation for strategic decision-making.</p>}
                      {index === 1 && <p className="text-xs text-gray-500">We apply proven frameworks that have delivered results across diverse industries.</p>}
                      {index === 2 && <p className="text-xs text-gray-500">Our collaborative approach ensures sustainable implementation and knowledge transfer.</p>}
                    </div>
                  </HoverCardContent>
                </HoverCard>)}
            </div>
              ...
              <div className="max-w-3xl mx-auto">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3 gap-2">
                  <div className="flex items-center">
                    <h3 className="text-xl font-bold">Collaborative Implementation</h3>
                  </div>
                  <div className="flex items-center">
                    <span className="text-sm text-gray-500 mr-2">Iterative Approach</span>
                    <RefreshCcw className="h-5 w-5 text-gray-600 animate-rotate-slow" />
                  </div>
                </div>
                
                <p className="text-gray-600 mb-4">Working collaboratively with clients to ensure sustainable change and knowledge transfer</p>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-6 gap-2">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-gray-600">Client feedback integrated at every milestone</span>
                  </div>
                  <div className="text-sm text-gray-500 flex items-center mt-2 sm:mt-0">
                    <span className="mr-2">Continuous optimization</span>
            ...
            <div className="bg-gradient-to-r from-gray-100 via-white to-gray-100 rounded-lg p-8 max-w-xl mx-auto text-center shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-xl font-bold mb-2">Sustainable Results</h3>
              <p className="text-gray-700">Ready to scale, implement, and maintain long-term success</p>
          ...
          <div className="text-center">
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              <Button onClick={scrollToServices} className="inline-flex items-center px-4 sm:px-6 bg-white text-gray-700 rounded-lg border border-gray-200 hover:bg-gray-50 hover:shadow-md transition-all group py-3 w-full sm:w-auto justify-center">
                Learn More About Our Services
                <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </Button>
              
              <Button onClick={scrollToContact} className="inline-flex items-center px-4 sm:px-6 py-3 bg-[#000f60] hover:bg-[#000f60] text-white rounded-lg shadow-md hover:shadow-lg transition-all group w-full sm:w-auto justify-center">
                Contact Our Experts
