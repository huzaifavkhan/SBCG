...
import EnhancedNewsContent from '@/components/EnhancedNewsContent';
...
const NewsPostDetail = () => {
  ...
  const post = newsPosts.find(post => post.slug === slug);
      ...
      <article className="w-full pt-16 pb-16">
          ...
          <div className="banner-overlay">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 w-full h-full flex items-center justify-start md:justify-center">
              <div className="w-full max-w-4xl mx-auto text-left md:text-center">
                <Link to="/news" className="inline-flex items-center text-gray-300 hover:text-white mb-4 transition-colors text-sm">
        ...
        <div className="container mx-auto px-4 py-8 sm:py-12 md:py-16">
          <div className="max-w-4xl mx-auto">
            <EnhancedNewsContent content={post.content} />
          </div>
        </div>
      </article>
    </PageLayout>
